...
class VectorRetrieval:
    ...
    def __init__(self, qdrant_path: str = "./qdrant_data", client=None):
        """
    ...
    def search_and_combine(
        ...
        Args:
            ...
            gender: Exact gender filter ("Male", "Female", "Other", "Unknown")
            age_min: Minimum age filter
            age_max: Maximum age filter
            height_min: Minimum height in cm filter
            height_max: Maximum height in cm filter
...
if __name__ == "__main__":
    ...
    try:
        ...
        retrieval = VectorRetrieval(qdrant_path="./qdrant_data")
        ...
        print(f"\n✗ Error: {e}")
        print("\nMake sure:")
        print("  1. qdrant_data directory is accessible")
